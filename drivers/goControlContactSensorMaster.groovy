...
def setOpen() {
    ...
    sendEvent(name: "internalContact", value: "open", displayed: false, isStateChange: true)
    sendEvent(name: "primaryStatus", value: "open", displayed: false, isStateChange: true)
...
def setClose() {
    ...
    sendEvent(name: "internalContact", value: "closed", displayed: false, isStateChange: true)
    sendEvent(name: "primaryStatus", value: "closed", displayed: false, isStateChange: true)
	def nowDay = new Date().format("MM/dd/yyyy", location.timeZone)
	def nowTime = new Date().format("hh:mm:ss a", location.timeZone)
...
def openExternal() {
    sendEvent(name: "externalContact", value: "open", displayed: false, isStateChange: true)
    handleChildContactEvent("open")
}

def closeExternal() {
    sendEvent(name: "externalContact", value: "closed", displayed: false, isStateChange: true)
    handleChildContactEvent("closed")
}
...
private void createChildDevice() {
	try {
		...
		//addChildDevice("GoControl External Contact Sensor Child", childDeviceNetworkId, null, options)	
		addChildDevice("mbarone", "GoControl External Contact Sensor Child", getChildDeviceNetworkId(), options)	
	}
	catch (e) {
